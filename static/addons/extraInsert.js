...
function extraInsert(item) {
    switch (item) {
        case "plus":
            newbuttonID = insert("button");
            newbuttonElement = document.getElementById(newbuttonID);
            newbuttonElement.innerHTML = "";
            newbuttonElement.style.backgroundColor = "#fff";
            newbuttonElement.style.color = "#fff";
            newbuttonElement.style.border = "0";
            newbuttonElement.style.backgroundImage = "url(\"data:image/svg+xml,%3Csvg viewBox='0 0 20 20' version='1.1' xmlns='http://www.w3.org/2000/svg' fill='%23000000'%3E%3Cg id='SVGRepo_bgCarrier' stroke-width='0'%3E%3C/g%3E%3Cg id='SVGRepo_tracerCarrier' stroke-linecap='round' stroke-linejoin='round'%3E%3C/g%3E%3Cg id='SVGRepo_iconCarrier'%3E%3Cg id='layer1'%3E%3Cpath d='M 9 3 L 9 10 L 2 10 L 2 11 L 9 11 L 9 18 L 10 18 L 10 11 L 17 11 L 17 10 L 10 10 L 10 3 L 9 3 z ' style='fill:%23222222; fill-opacity:1; stroke:none; stroke-width:0px;'%3E%3C/path%3E%3C/g%3E%3C/g%3E%3C/svg%3E\") ";
            rename(newbuttonID, "Plus");
            break;
        case "refresh":
            newbuttonID = insert("button");
            newbuttonElement = document.getElementById(newbuttonID);
        ...
        case "back":
            ...
            newbuttonElement.style.color = "#fff";
            newbuttonElement.style.border = "0";
            newbuttonElement.style.backgroundImage = "url(\"data:image/svg+xml,%3Csvg viewBox='0 0 1024 1024' xmlns='http://www.w3.org/2000/svg' fill='%23000000'%3E%3Cg id='SVGRepo_bgCarrier' stroke-width='0'%3E%3C/g%3E%3Cg id='SVGRepo_tracerCarrier' stroke-linecap='round' stroke-linejoin='round'%3E%3C/g%3E%3Cg id='SVGRepo_iconCarrier'%3E%3Cpath fill='%23000000' d='M224 480h640a32 32 0 1 1 0 64H224a32 32 0 0 1 0-64z'%3E%3C/path%3E%3Cpath fill='%23000000' d='m237.248 512 265.408 265.344a32 32 0 0 1-45.312 45.312l-288-288a32 32 0 0 1 0-45.312l288-288a32 32 0 1 1 45.312 45.312L237.248 512z'%3E%3C/path%3E%3C/g%3E%3C/svg%3E\") ";
            rename(newbuttonID, "Back");
            break;
        case "home":
            newbuttonID = insert("button");
            newbuttonElement = document.getElementById(newbuttonID);
            ...
            newbuttonElement.style.color = "#fff";
            newbuttonElement.style.border = "0";
            newbuttonElement.style.backgroundImage = "url(\"data:image/svg+xml,%3Csvg fill='%23000000' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'%3E%3Cg id='SVGRepo_bgCarrier' stroke-width='0'%3E%3C/g%3E%3Cg id='SVGRepo_tracerCarrier' stroke-linecap='round' stroke-linejoin='round'%3E%3C/g%3E%3Cg id='SVGRepo_iconCarrier'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M21.4498 10.275L11.9998 3.1875L2.5498 10.275L2.9998 11.625H3.7498V20.25H20.2498V11.625H20.9998L21.4498 10.275ZM5.2498 18.75V10.125L11.9998 5.0625L18.7498 10.125V18.75H14.9999V14.3333L14.2499 13.5833H9.74988L8.99988 14.3333V18.75H5.2498ZM10.4999 18.75H13.4999V15.0833H10.4999V18.75Z'%3E%3C/path%3E%3C/g%3E%3C/svg%3E\") ";
            rename(newbuttonID, "Home");
            break;
    }
}